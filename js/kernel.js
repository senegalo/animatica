...
Animatica.prototype.nextTrack = function(f){
    var current = this.scenario[f].sounds.pop();
    var self = this;
    ...
    if(current.delay){
        delete current.delay;
        this.scenario[f].sounds.splice(0,0,current);
        setTimeout(function(){
            self.nextTrack(f);
        },current.delay);
    }
